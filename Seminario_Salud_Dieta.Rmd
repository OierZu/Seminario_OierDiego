...
A partir de los datos gráficos obtenidos, es posible inferir una correlación entre la diabetes tipo 2 y la pertenencia étnica (blanca o negra).Estas conclusiones respaldan en parte lo que dicen los artículos sobre este tema, mostrando que la raza tiene importancia en cómo se manifiesta esta condición médica. He [aquí](https://www.aarp.org/espanol/salud/vida-saludable/info-2018/raza-y-el-riesgo-de-diabetes.html) un artículo que lo respalda. Gracias a esta gráfica también podemos observar que otra relación entre la edad y el nº de muertes por esta causa. \### Tercer Objetivo
