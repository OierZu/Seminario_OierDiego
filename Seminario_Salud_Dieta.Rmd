...
# Suponiendo que 'nueva_tabla' es tu tabla con los datos
datos_long <- tidyr::gather(nueva_tabla, key = "Columna", value = "Valor")

# Gráfico de líneas para las diferentes columnas de 'nueva_tabla'
ggplot(datos_long, aes(x = Columna, y = Valor, color = Columna)) +
  geom_line() +
  labs(x = "Columna", y = "Valor", title = "Gráfico de las columnas de 'nueva_tabla'") +
  theme_minimal()
