...
nueva_tabla$CT <- gsub("[^0-9.]", "", nueva_tabla$CT)

# Convertir a valores numéricos
nueva_tabla$CT <- as.numeric(nueva_tabla$CT)

# Generar un boxplot para la columna "CT" de la tabla 'nueva_tabla'
boxplot(nueva_tabla$CT, col = "green", main = "Boxplot de CT en nueva_tabla")

# Obtener los datos de la columna CT de nueva_tabla
datos <- nueva_tabla$CT
